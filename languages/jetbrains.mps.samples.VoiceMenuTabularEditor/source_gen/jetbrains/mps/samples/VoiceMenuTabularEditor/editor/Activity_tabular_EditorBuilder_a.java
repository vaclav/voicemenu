...
/*package*/ class Activity_tabular_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_tm0j27_a() {
    ...
    style.set(StyleAttributes.NAVIGATABLE_NODE, _StyleParameter_QueryFunction_tm0j27_a0a());
    editorCell.getStyle().putAll(style);
    editorCell.addEditorCell(createConstant_tm0j27_a0());
    editorCell.addEditorCell(createRefCell_tm0j27_b0());
    editorCell.addEditorCell(createConstant_tm0j27_c0());
    editorCell.addEditorCell(createRefCell_tm0j27_d0());
    if (nodeCondition_tm0j27_a4a()) {
      editorCell.addEditorCell(createConstant_tm0j27_e0());
    }
    if (nodeCondition_tm0j27_a5a()) {
      editorCell.addEditorCell(createConstant_tm0j27_f0());
    }
    if (nodeCondition_tm0j27_a6a()) {
      editorCell.addEditorCell(createProperty_tm0j27_g0());
    }
    editorCell.addEditorCell(createConstant_tm0j27_h0());
    editorCell.addEditorCell(createRefNode_tm0j27_i0());
    return editorCell;
  }
  private boolean nodeCondition_tm0j27_a4a() {
  ...
  private boolean nodeCondition_tm0j27_a5a() {
    return isNotEmptyString(SPropertyOperations.getString(myNode, MetaAdapterFactory.getProperty(0x4bc750d756884f52L, 0xb7d5b263a3393a24L, 0x5b6b060cf3fde68dL, 0x25806c66fbe600f7L, "greeting")));
  }
  private boolean nodeCondition_tm0j27_a6a() {
    return isNotEmptyString(SPropertyOperations.getString(myNode, MetaAdapterFactory.getProperty(0x4bc750d756884f52L, 0xb7d5b263a3393a24L, 0x5b6b060cf3fde68dL, 0x25806c66fbe600f7L, "greeting")));
  }
  private SNode _StyleParameter_QueryFunction_tm0j27_a0a() {
  ...
  private EditorCell createRefCell_tm0j27_b0() {
  ...
  /*package*/ static class Inline_Builder_tm0j27_a1a extends AbstractEditorBuilder {
    @NotNull
    private SNode myNode;
    private SNode myReferencingNode;

    /*package*/ Inline_Builder_tm0j27_a1a(@NotNull EditorContext context, SNode referencingNode, @NotNull SNode node) {
      super(context);
    ...
    /*package*/ EditorCell createCell() {
      return createCollection_tm0j27_a0b0();
    }
    ...
    private EditorCell createCollection_tm0j27_a0b0() {
      EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
      editorCell.setCellId("Collection_tm0j27_a0b0");
      Style style = new StyleImpl();
      style.set(StyleAttributes.SELECTABLE, false);
      editorCell.getStyle().putAll(style);
      if (nodeCondition_tm0j27_a0a0b0()) {
        editorCell.addEditorCell(createProperty_tm0j27_a0a1a());
      }
      return editorCell;
    }
    private boolean nodeCondition_tm0j27_a0a0b0() {
    ...
    private EditorCell createProperty_tm0j27_a0a1a() {
  ...
  private EditorCell createConstant_tm0j27_c0() {
    ...
    editorCell.setCellId("Constant_tm0j27_c0");
    Style style = new StyleImpl();
    new HardCodedTextStyleClass(getEditorContext(), getNode()).apply(style, editorCell);
    style.set(StyleAttributes.EDITABLE, false);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createRefCell_tm0j27_d0() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, getEditorContext()) {
  ...
  /*package*/ static class Inline_Builder_tm0j27_a3a extends AbstractEditorBuilder {
    @NotNull
    private SNode myNode;
    private SNode myReferencingNode;

    /*package*/ Inline_Builder_tm0j27_a3a(@NotNull EditorContext context, SNode referencingNode, @NotNull SNode node) {
      super(context);
      myReferencingNode = referencingNode;
      myNode = node;
    }
    ...
    /*package*/ EditorCell createCell() {
      return createProperty_tm0j27_a0d0();
    }
  ...
  private EditorCell createProperty_tm0j27_g0() {
    ...
    style.set(StyleAttributes.SELECTABLE, true);
    style.set(StyleAttributes.NAVIGATABLE_NODE, _StyleParameter_QueryFunction_tm0j27_a1g0());
    editorCell.getStyle().putAll(style);
    RemoveGreeting.setCellActions(editorCell, myNode, getEditorContext());
    editorCell.setSubstituteInfo(provider.createDefaultSubstituteInfo());
    SNode attributeConcept = provider.getRoleAttribute();
  ...
  private SNode _StyleParameter_QueryFunction_tm0j27_a1g0() {
    return SLinkOperations.getTarget(getNode(), MetaAdapterFactory.getReferenceLink(0x4bc750d756884f52L, 0xb7d5b263a3393a24L, 0x5b6b060cf3fde68dL, 0x5b6b060cf3fe08f3L, "event"));
  }
  private EditorCell createConstant_tm0j27_h0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
    editorCell.setCellId("Constant_tm0j27_h0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.EDITABLE, false);
    style.set(StyleAttributes.SELECTABLE, false);
  ...
  private EditorCell createRefNode_tm0j27_i0() {
    SingleRoleCellProvider provider = new Activity_tabular_EditorBuilder_a.commandsSingleRoleHandler_tm0j27_i0(myNode, MetaAdapterFactory.getContainmentLink(0x4bc750d756884f52L, 0xb7d5b263a3393a24L, 0x5b6b060cf3fde68dL, 0x5b6b060cf3fe08d2L, "commands"), getEditorContext());
    return provider.createCell();
  }
  private static class commandsSingleRoleHandler_tm0j27_i0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public commandsSingleRoleHandler_tm0j27_i0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createEmptyCell() {
      ...
      try {
        EditorCell editorCell = createConstant_tm0j27_a8a();
    ...
    private EditorCell createConstant_tm0j27_a8a() {
      EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "menu");
      editorCell.setCellId("Constant_tm0j27_a8a");
      editorCell.setDefaultText("");
      return editorCell;
    }
  }
