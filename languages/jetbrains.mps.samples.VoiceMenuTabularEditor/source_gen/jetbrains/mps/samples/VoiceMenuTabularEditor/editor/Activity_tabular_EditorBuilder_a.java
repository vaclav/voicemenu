...
/*package*/ class Activity_tabular_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_tm0j27_a0a() {
    return !(Objects.equals(SPropertyOperations.getString(SLinkOperations.getTarget(myNode, LINKS.event$gjCV), PROPS.trigger$zpYt), "X"));
  }
  ...
  /*package*/ static class Inline_Builder0 extends AbstractEditorBuilder {
    ...
    private boolean nodeCondition_tm0j27_a0a0b0a() {
      return isNotEmptyString(SPropertyOperations.getString(myNode, PROPS.trigger$zpYt));
    }
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new commandsSingleRoleHandler_tm0j27_i0a(myNode, LINKS.commands$giUr, getEditorContext());
