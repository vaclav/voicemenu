...
/*package*/ class Menu_tabular_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new activitiesListHandler_tmw21j_c0(myNode, getEditorContext());
  ...
  private static class activitiesListHandler_tmw21j_c0 extends RefNodeListHandler {
    ...
    public activitiesListHandler_tmw21j_c0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(activitiesListHandler_tmw21j_c0.this.getNode(), LINKS.activities$gAHC));
      try {
