...
/*package*/ class VoiceMenuTestCase_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.workspaceToTest$OyBX;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.workspaceToTest$OyBX);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.workspaceToTest$OyBX);
    }
  ...
  private static class commandsListHandler_vee4f0_e0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.commands$RX3w;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.Command$o_;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(commandsListHandler_vee4f0_e0.this.getNode(), LINKS.commands$RX3w));
      try {
