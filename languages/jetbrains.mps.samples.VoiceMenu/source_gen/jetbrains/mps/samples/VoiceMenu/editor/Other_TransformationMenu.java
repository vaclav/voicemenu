...
public class Other_TransformationMenu extends TransformationMenuBase {
  public Other_TransformationMenu() {
    super(false, new EditorMenuDescriptorBase("default transformation menu for " + "Other", new SNodePointer("r:7c1e5bbb-2d18-4cf3-a11d-502be6b13261(jetbrains.mps.samples.VoiceMenu.editor)", "5842359129972225022")), List.<String>of(MenuLocations.CONTEXT_ACTIONS_TOOL));
  }
