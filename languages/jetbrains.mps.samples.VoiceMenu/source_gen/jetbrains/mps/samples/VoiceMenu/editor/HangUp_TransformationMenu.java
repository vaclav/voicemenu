...
public class HangUp_TransformationMenu extends TransformationMenuBase {
  ...
  public class TMP_SubMenu_uyi3ql_a3 extends SubMenuMenuTransformationMenuPart {
    ...
    @Override
    protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts() {
      return Arrays.<MenuPart<TransformationMenuItem, TransformationMenuContext>>asList(new HangUp_TransformationMenu.TMP_SubMenu_uyi3ql_a3.TMP_Action_uyi3ql_a0d(), new HangUp_TransformationMenu.TMP_SubMenu_uyi3ql_a3.TMP_Action_uyi3ql_b0d(), new HangUp_TransformationMenu.TMP_SubMenu_uyi3ql_a3.TMP_Action_uyi3ql_c0d(), new HangUp_TransformationMenu.TMP_SubMenu_uyi3ql_a3.TMP_Action_uyi3ql_d0d(), new HangUp_TransformationMenu.TMP_SubMenu_uyi3ql_a3.TMP_Action_uyi3ql_e0d(), new HangUp_TransformationMenu.TMP_SubMenu_uyi3ql_a3.TMP_Action_uyi3ql_f0d());
    }
    ...
    private class TMP_Action_uyi3ql_c0d extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SidebarActionItem {
        ...
        @Override
        public IconResource getIcon() {
          return IconContainer.RESOURCE_a0a01c8k_0;
        }
        @Override
        public String getTooltipText() {
          return null;
