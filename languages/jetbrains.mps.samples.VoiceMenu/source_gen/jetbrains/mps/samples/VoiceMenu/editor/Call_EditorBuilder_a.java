...
/*package*/ class Call_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_m420n_a() {
    ...
    editorCell.addEditorCell(createImage_m420n_a0());
    editorCell.addEditorCell(createConstant_m420n_b0());
    editorCell.addEditorCell(createConstant_m420n_c0());
    return editorCell;
  }
  private EditorCell createImage_m420n_a0() {
    SModule imageModule;
    String imagePath;
    ...
    editorCell.setCellId("Image_m420n_a0");
  ...
  private EditorCell createConstant_m420n_b0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
    editorCell.setCellId("Constant_m420n_b0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
