...
public class DirectCall_TransformationMenu extends TransformationMenuBase {
  ...
  public class TMP_SubMenu_eoxtbk_a0 extends SubMenuMenuTransformationMenuPart {
    ...
    protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts() {
      return Arrays.<MenuPart<TransformationMenuItem, TransformationMenuContext>>asList(new DirectCall_TransformationMenu.TMP_SubMenu_eoxtbk_a0.TMP_Action_eoxtbk_a0a(), new DirectCall_TransformationMenu.TMP_SubMenu_eoxtbk_a0.TMP_Action_eoxtbk_b0a(), new DirectCall_TransformationMenu.TMP_SubMenu_eoxtbk_a0.TMP_Action_eoxtbk_c0a());
    }
    ...
    private class TMP_Action_eoxtbk_c0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      @Nullable
      protected TransformationMenuItem createItem(TransformationMenuContext context) {
        return new DirectCall_TransformationMenu.TMP_SubMenu_eoxtbk_a0.TMP_Action_eoxtbk_c0a.Item(context);
      }
