...
public class DirectCall_TransformationMenu extends TransformationMenuBase {
  public DirectCall_TransformationMenu() {
    super(false, new EditorMenuDescriptorBase("default transformation menu for " + "DirectCall", new SNodePointer("r:7c1e5bbb-2d18-4cf3-a11d-502be6b13261(jetbrains.mps.samples.VoiceMenu.editor)", "5842359129972221990")), List.<String>of(MenuLocations.CONTEXT_ACTIONS_TOOL));
  }
