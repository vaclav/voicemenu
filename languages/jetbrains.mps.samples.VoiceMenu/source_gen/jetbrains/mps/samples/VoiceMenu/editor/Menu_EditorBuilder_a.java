...
/*package*/ class Menu_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_gd4rom_a1a0a() {
    return ListSequence.fromList(SLinkOperations.getChildren(myNode, LINKS.events$gxkh)).isNotEmpty();
  }
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new eventsListHandler_gd4rom_a0a0(myNode, getEditorContext());
  ...
  private static class eventsListHandler_gd4rom_a0a0 extends RefNodeListHandler {
    ...
    public eventsListHandler_gd4rom_a0a0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(eventsListHandler_gd4rom_a0a0.this.getNode(), LINKS.events$gxkh));
      try {
  ...
  private EditorCell createRefNodeList_1() {
    AbstractCellListHandler handler = new activitiesListHandler_gd4rom_b0a0(myNode, getEditorContext());
  ...
  private static class activitiesListHandler_gd4rom_b0a0 extends RefNodeListHandler {
    ...
    public activitiesListHandler_gd4rom_b0a0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(activitiesListHandler_gd4rom_b0a0.this.getNode(), LINKS.activities$gAHC));
      try {
        EditorCell emptyCell = null;
        emptyCell = super.createEmptyCell();
        installElementCellActions(null, emptyCell, true);
