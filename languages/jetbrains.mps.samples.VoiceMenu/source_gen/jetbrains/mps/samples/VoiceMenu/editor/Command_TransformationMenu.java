...
public class Command_TransformationMenu extends TransformationMenuBase {
  public Command_TransformationMenu() {
    super(false, new EditorMenuDescriptorBase("default transformation menu for " + "Command", new SNodePointer("r:7c1e5bbb-2d18-4cf3-a11d-502be6b13261(jetbrains.mps.samples.VoiceMenu.editor)", "4660170996523424395")), List.<String>of(MenuLocations.CONTEXT_ACTIONS_TOOL, MenuLocations.CONTEXT_ACTIONS_TOOL, MenuLocations.CONTEXT_ACTIONS_TOOL));
  }
  ...
  public class TMP_SubMenu_8e2zmm_a0 extends SubMenuMenuTransformationMenuPart {
    ...
    private class TMP_Action_8e2zmm_a0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SidebarActionItem {
        ...
        /*package*/ Item resetTraceInfo() {
          updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:7c1e5bbb-2d18-4cf3-a11d-502be6b13261(jetbrains.mps.samples.VoiceMenu.editor)", "971041030104423372"));
          return this;
        }
        @Nullable
        @Override
        ...
        public IconResource getIcon() {
          ...
          if (end == true) {
            return IconContainer.RESOURCE_a0a3a8c6e;
          } else {
            return IconContainer.RESOURCE_a0a0d0i2g4;
          }
        }
        @Override
    ...
    private class TMP_Action_8e2zmm_b0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SidebarActionItem {
        ...
        /*package*/ Item resetTraceInfo() {
          updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:7c1e5bbb-2d18-4cf3-a11d-502be6b13261(jetbrains.mps.samples.VoiceMenu.editor)", "7229855446159341697"));
          return this;
        }
        @Nullable
        @Override
        ...
        @Override
        public IconResource getIcon() {
          return IconContainer.RESOURCE_a0a8c7e_3;
        }
        @Override
        public String getTooltipText() {
          return null;
    ...
    private class TMP_Action_8e2zmm_c0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SidebarActionItem {
        ...
        /*package*/ Item resetTraceInfo() {
          updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:7c1e5bbb-2d18-4cf3-a11d-502be6b13261(jetbrains.mps.samples.VoiceMenu.editor)", "7229855446159341744"));
          return this;
        }
        @Nullable
        @Override
        ...
        @Override
        public IconResource getIcon() {
          return IconContainer.RESOURCE_a0a8c8e_1;
        }
        @Override
        public String getTooltipText() {
          return null;
  ...
  public class TMP_SubMenu_8e2zmm_a1 extends SubMenuMenuTransformationMenuPart {
    ...
    private class TMP_Action_8e2zmm_a0b extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SidebarActionItem {
        ...
        /*package*/ Item resetTraceInfo() {
          updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:7c1e5bbb-2d18-4cf3-a11d-502be6b13261(jetbrains.mps.samples.VoiceMenu.editor)", "7229855446163207111"));
          return this;
        }
        @Nullable
        @Override
        ...
        @Override
        public IconResource getIcon() {
          return IconContainer.RESOURCE_a0a7c6f_1;
        }
        @Override
        public String getTooltipText() {
          return null;
    ...
    private class TMP_Action_8e2zmm_b0b extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SidebarActionItem {
        ...
        /*package*/ Item resetTraceInfo() {
          updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:7c1e5bbb-2d18-4cf3-a11d-502be6b13261(jetbrains.mps.samples.VoiceMenu.editor)", "4660170996523424408"));
          return this;
        }
        @Nullable
        @Override
        ...
        @Override
        public IconResource getIcon() {
          return IconContainer.RESOURCE_a0a8c7f_3;
        }
        @Override
        public String getTooltipText() {
          return null;
    ...
    private class TMP_Action_8e2zmm_c0b extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SidebarActionItem {
        ...
        /*package*/ Item resetTraceInfo() {
          updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:7c1e5bbb-2d18-4cf3-a11d-502be6b13261(jetbrains.mps.samples.VoiceMenu.editor)", "4660170996523424455"));
          return this;
        }
        @Nullable
        @Override
        ...
        @Override
        public IconResource getIcon() {
          return IconContainer.RESOURCE_a0a8c8f_1;
        }
        @Override
        public String getTooltipText() {
          return null;
  ...
  public class TMP_SubMenu_8e2zmm_a2 extends SubMenuMenuTransformationMenuPart {
    ...
    private class TMP_Action_8e2zmm_a0c extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SidebarActionItem {
        ...
        /*package*/ Item resetTraceInfo() {
          updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:7c1e5bbb-2d18-4cf3-a11d-502be6b13261(jetbrains.mps.samples.VoiceMenu.editor)", "4660170996528418962"));
          return this;
        }
        @Nullable
        @Override
        ...
        @Override
        public IconResource getIcon() {
          return IconContainer.RESOURCE_a0a8c6g_0;
        }
        @Override
        public String getTooltipText() {
          return null;
    ...
    private class TMP_Action_8e2zmm_b0c extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SidebarActionItem {
        ...
        /*package*/ Item resetTraceInfo() {
          updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:7c1e5bbb-2d18-4cf3-a11d-502be6b13261(jetbrains.mps.samples.VoiceMenu.editor)", "4660170996528418988"));
          return this;
        }
        @Nullable
        @Override
        ...
        @Override
        public IconResource getIcon() {
          return IconContainer.RESOURCE_a0a8c7g_1;
        }
        @Override
        public String getTooltipText() {
          return null;
    ...
    private class TMP_Action_8e2zmm_c0c extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SidebarActionItem {
        ...
        /*package*/ Item resetTraceInfo() {
          updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:7c1e5bbb-2d18-4cf3-a11d-502be6b13261(jetbrains.mps.samples.VoiceMenu.editor)", "4660170996528419014"));
          return this;
        }
        @Nullable
        @Override
        ...
        @Override
        public IconResource getIcon() {
          return IconContainer.RESOURCE_a0a8c8g_0;
        }
        @Override
        public String getTooltipText() {
          return null;
    ...
    private class TMP_Action_8e2zmm_d0c extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SidebarActionItem {
        ...
        /*package*/ Item resetTraceInfo() {
          updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:7c1e5bbb-2d18-4cf3-a11d-502be6b13261(jetbrains.mps.samples.VoiceMenu.editor)", "4660170996528419052"));
          return this;
        }
        @Nullable
        @Override
        ...
        @Override
        public IconResource getIcon() {
          return IconContainer.RESOURCE_a0a8c9g_0;
        }
        @Override
        public String getTooltipText() {
          return null;
    ...
    private class TMP_Action_8e2zmm_e0c extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SidebarActionItem {
        ...
        /*package*/ Item resetTraceInfo() {
          updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:7c1e5bbb-2d18-4cf3-a11d-502be6b13261(jetbrains.mps.samples.VoiceMenu.editor)", "4660170996528419086"));
          return this;
        }
        @Nullable
        @Override
        ...
        @Override
        public IconResource getIcon() {
          return IconContainer.RESOURCE_a0a8c01g;
        }
        @Override
        public String getTooltipText() {
          return null;
    ...
    private class TMP_Action_8e2zmm_f0c extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SidebarActionItem {
        ...
        /*package*/ Item resetTraceInfo() {
          updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:7c1e5bbb-2d18-4cf3-a11d-502be6b13261(jetbrains.mps.samples.VoiceMenu.editor)", "4660170996528419112"));
          return this;
        }
        @Nullable
        @Override
        ...
        @Override
        public IconResource getIcon() {
          return IconContainer.RESOURCE_a0a8c11g;
        }
        @Override
        public String getTooltipText() {
          return null;
    ...
    private class TMP_Action_8e2zmm_g0c extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SidebarActionItem {
        ...
        /*package*/ Item resetTraceInfo() {
          updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:7c1e5bbb-2d18-4cf3-a11d-502be6b13261(jetbrains.mps.samples.VoiceMenu.editor)", "4660170996528419196"));
          return this;
        }
        @Nullable
        @Override
        ...
        @Override
        public IconResource getIcon() {
          return IconContainer.RESOURCE_a0a8c21g;
        }
        @Override
        public String getTooltipText() {
          return null;
    ...
    private class TMP_Action_8e2zmm_h0c extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SidebarActionItem {
        ...
        /*package*/ Item resetTraceInfo() {
          updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:7c1e5bbb-2d18-4cf3-a11d-502be6b13261(jetbrains.mps.samples.VoiceMenu.editor)", "4660170996528419230"));
          return this;
        }
        @Nullable
        @Override
        ...
        @Override
        public IconResource getIcon() {
          return IconContainer.RESOURCE_a0a8c31g;
        }
        @Override
        public String getTooltipText() {
          return null;
