...
public class Menu_TransformationMenu extends TransformationMenuBase {
  ...
  public class TMP_SubMenu_caopkk_a0 extends SubMenuMenuTransformationMenuPart {
    ...
    private class TMP_Action_caopkk_c0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      @Nullable
      protected TransformationMenuItem createItem(TransformationMenuContext context) {
        return new Menu_TransformationMenu.TMP_SubMenu_caopkk_a0.TMP_Action_caopkk_c0a.Item(context);
      }
    ...
    private class TMP_Action_caopkk_d0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      @Nullable
      protected TransformationMenuItem createItem(TransformationMenuContext context) {
        return new Menu_TransformationMenu.TMP_SubMenu_caopkk_a0.TMP_Action_caopkk_d0a.Item(context);
      }
      ...
      private class Item extends ActionItemBase implements SidebarActionItem {
        ...
        @Override
        public IconResource getIcon() {
          return IconContainer.RESOURCE_a0a9c9h_3;
        }
        @Override
        public String getTooltipText() {
          return null;
