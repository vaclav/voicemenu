package jetbrains.mps.samples.VoiceMenu.plugin;
...
public class RenameXmlToHtml_Facet extends IFacet.Stub {
  ...
  private IFacet.Name name = new IFacet.Name("jetbrains.mps.samples.VoiceMenu.RenameXmlToHtml");
  ...
  public static class Target_doRename implements ITargetEx {
    private static final ITarget.Name name = new ITarget.Name("jetbrains.mps.samples.VoiceMenu.RenameXmlToHtml.doRename");
