...
public class MoveTimeoutToTop_QuickFix extends QuickFix_Runtime {
  ...
  public void execute(SNode node) {
    SNode srcTiemout = ListSequence.fromList(SLinkOperations.getChildren(((SNode) MoveTimeoutToTop_QuickFix.this.getField("menu")[0]), MetaAdapterFactory.getContainmentLink(0x4bc750d756884f52L, 0xb7d5b263a3393a24L, 0x5b6b060cf3fde308L, 0x5b6b060cf3fde68aL, "activities"))).findFirst(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return eq_m2js0e_a0a0a0a0a0a0a2(SPropertyOperations.getString(SLinkOperations.getTarget(it, MetaAdapterFactory.getReferenceLink(0x4bc750d756884f52L, 0xb7d5b263a3393a24L, 0x5b6b060cf3fde68dL, 0x5b6b060cf3fe08f3L, "event")), MetaAdapterFactory.getProperty(0x4bc750d756884f52L, 0xb7d5b263a3393a24L, 0x5b6b060cf3fde30cL, 0x5b6b060cf3fde310L, "trigger")), "X");
      }
    });
  ...
  private static boolean eq_m2js0e_a0a0a0a0a0a0a2(Object a, Object b) {
