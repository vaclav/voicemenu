...
public final class DeclareActivity4_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  private static final Logger LOG = LogManager.getLogger(DeclareActivity4_Intention.class);
  private Collection<IntentionExecutable> myCachedExecutable;
  public DeclareActivity4_Intention() {
  ...
  public Collection<IntentionExecutable> instances(final SNode node, final EditorContext context) {
    if (myCachedExecutable == null) {
      myCachedExecutable = Collections.<IntentionExecutable>singletonList(new DeclareActivity4_Intention.IntentionImplementation());
    }
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
      ...
      try {
        for (EditorCell cell : Sequence.fromIterable(contentCells)) {
          if (LOG.isInfoEnabled()) {
            LoggingRuntime.legacyLog(Level.INFO, ((EditorCell_Constant) cell).getText(), DeclareActivity4_Intention.class, null);
          }
          counter++;
          if (counter == 2) {
            name = ((EditorCell_Constant) cell).getText().toString();
            if (LOG.isInfoEnabled()) {
              LoggingRuntime.legacyLog(Level.INFO, "Jmeno: " + name, DeclareActivity4_Intention.class, null);
            }
          ...
          if (counter == 4) {
            ...
            if (LOG.isInfoEnabled()) {
              LoggingRuntime.legacyLog(Level.INFO, "Trigger: " + trigger, DeclareActivity4_Intention.class, null);
            }
    ...
    public IntentionDescriptor getDescriptor() {
      return DeclareActivity4_Intention.this;
    }
  }
}
