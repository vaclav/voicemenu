...
public class Main implements ActionListener {
  ...
  public static void initHashMap() {
    ...
    Variables.path = Variables.path.substring(0, Variables.path.length() - 1);
    Four_pm98_a0a0a0.childs = new ArrayList<Event>();
    Event Four_pm98_a0a0a0_0 = new Event("Four", "4");
    Four_pm98_a0a0a0_0.setAction("");
    Four_pm98_a0a0a0_0.setGreeting("");
    Four_pm98_a0a0a0_0.childs = new ArrayList<Event>();
    Variables.path = Variables.path + Four_pm98_a0a0a0_0.trigger;
    Variables.myHashMap.put(Variables.path, Four_pm98_a0a0a0_0);
