...
public class Main__0 implements ActionListener {
  ...
  public static void initHashMap() {
    ...
    Variables.myHashMap.put("02", var_qy4hiv_c0);
    Event var_qy4hiv_a0a0 = new Event("Action_108", "1");
    var_qy4hiv_a0a0.setAction("");
    var_qy4hiv_a0a0.setGreeting("");
    var_qy4hiv_a0a0.childs = new ArrayList<Event>();
    Variables.myHashMap.put("021", var_qy4hiv_a0a0);
    var_qy4hiv_a0a0.setAction("other");
    var_qy4hiv_a0a0.childs = new ArrayList<Event>();
    Event var_qy4hiv_b0a0 = new Event("Action_117", "2");
    var_qy4hiv_b0a0.setAction("");
    var_qy4hiv_b0a0.setGreeting("");
    var_qy4hiv_b0a0.childs = new ArrayList<Event>();
    Variables.myHashMap.put("022", var_qy4hiv_b0a0);
    var_qy4hiv_b0a0.setAction("other");
    var_qy4hiv_b0a0.childs = new ArrayList<Event>();
    var_qy4hiv_c0.childs = new ArrayList<Event>();
    var_qy4hiv_c0.childs.add(var_qy4hiv_a0a0);
    var_qy4hiv_c0.childs.add(var_qy4hiv_b0a0);
    ...
    Variables.myHashMap.put("05", var_qy4hiv_b0);
    ...
    Variables.myHashMap.put("04", var_qy4hiv_a0);
