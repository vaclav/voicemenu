...
public class Main__0 implements ActionListener {
  ...
  public static void initHashMap() {
    ...
    _Five_qy4hiv_b0.setAction("back");
    Variables.path = Variables.path.substring(0, Variables.path.length() - 1);
    _Five_qy4hiv_b0.childs = new ArrayList<Event>();
    ...
    _Nine_qy4hiv_c0.setAction("call");
    Variables.path = Variables.path.substring(0, Variables.path.length() - 1);
    _Nine_qy4hiv_c0.childs = new ArrayList<Event>();
    Event _dfsa_qy4hiv_d0 = new Event("dfsa", "0");
    _dfsa_qy4hiv_d0.setAction("");
    _dfsa_qy4hiv_d0.setGreeting("");
    _dfsa_qy4hiv_d0.childs = new ArrayList<Event>();
    Variables.path = Variables.path + _dfsa_qy4hiv_d0.trigger;
    Variables.myHashMap.put(Variables.path, _dfsa_qy4hiv_d0);
    Variables.path = Variables.path.substring(0, Variables.path.length() - 1);
    _dfsa_qy4hiv_d0.childs = new ArrayList<Event>();
    ...
    Home.childs.add(_dfsa_qy4hiv_d0);
  }
