...
public class Main__0 implements ActionListener {
  ...
  public static void initHashMap() {
    ...
    Event var_qy4hiv_a0 = new Event("One", "1");
    ...
    Event var_qy4hiv_a0a0 = new Event("One", "1");
    ...
    Variables.myHashMap.put("012", var_qy4hiv_b0a0);
    var_qy4hiv_b0a0.setAction("other");
    var_qy4hiv_b0a0.childs = new ArrayList<Event>();
    var_qy4hiv_a0.childs = new ArrayList<Event>();
    var_qy4hiv_a0.childs.add(var_qy4hiv_a0a0);
    var_qy4hiv_a0.childs.add(var_qy4hiv_b0a0);
