...
public class Main__4 implements ActionListener {
  ...
  public static void initHashMap() {
    ...
    Event Timeout_o0tsw_c0b0 = new Event("Timeout", "X", 16);
    Timeout_o0tsw_c0b0.isFinal = false;
    Timeout_o0tsw_c0b0.setAction("", false);
    Timeout_o0tsw_c0b0.setGreeting("");
    Timeout_o0tsw_c0b0.childs = new ArrayList<Event>();
    Variables.myHashMap.put("02X", Timeout_o0tsw_c0b0);
    Timeout_o0tsw_c0b0.setAction("repeat", false);
    Timeout_o0tsw_c0b0.childs = new ArrayList<Event>();
    Event HangUp_o0tsw_a0b0 = new Event("HangUp", "1", 16);
    HangUp_o0tsw_a0b0.isFinal = false;
    HangUp_o0tsw_a0b0.setAction("", false);
    HangUp_o0tsw_a0b0.setGreeting("");
    HangUp_o0tsw_a0b0.childs = new ArrayList<Event>();
    Variables.myHashMap.put("021", HangUp_o0tsw_a0b0);
    HangUp_o0tsw_a0b0.setAction("hangUp", true);
    HangUp_o0tsw_a0b0.childs = new ArrayList<Event>();
    Event GetInfo_o0tsw_b0b0 = new Event("GetInfo", "2", 16);
    GetInfo_o0tsw_b0b0.isFinal = false;
    GetInfo_o0tsw_b0b0.setAction("", false);
    GetInfo_o0tsw_b0b0.setGreeting("");
    GetInfo_o0tsw_b0b0.childs = new ArrayList<Event>();
    Variables.myHashMap.put("022", GetInfo_o0tsw_b0b0);
    GetInfo_o0tsw_b0b0.setAction("getInfo", false);
    GetInfo_o0tsw_b0b0.childs = new ArrayList<Event>();
    Menu_o0tsw_b0.childs = new ArrayList<Event>();
    Menu_o0tsw_b0.childs.add(HangUp_o0tsw_a0b0);
    Menu_o0tsw_b0.childs.add(GetInfo_o0tsw_b0b0);
