...
public class Jet_Mobile_ implements ActionListener {
  ...
  public static void initHashMap() {
    ...
    Home.setAction("", true);
    Home.setPlayBack("Welcome to " + "Jet Mobile");
    ...
    Summer_discount_br5dt0_a0a0a0.setAction("call", true);
    Summer_discount_br5dt0_a0a0a0.childs = new ArrayList<Event>();
    ...
    Hidden_discounts_br5dt0_b0a0a0.playback = "Secret info";
    ...
    Data_limit_br5dt0_b0a0.childs = new ArrayList<Event>();
    Event Return_to_main_menu_br5dt0_d0a0 = new Event("Return to main menu", "*");
    Return_to_main_menu_br5dt0_d0a0.isFinal = false;
    Return_to_main_menu_br5dt0_d0a0.setAction("", false);
    Return_to_main_menu_br5dt0_d0a0.playback = "Going back to the previous menu.";
    Return_to_main_menu_br5dt0_d0a0.childs = new ArrayList<Event>();
    Variables.myHashMap.put("01*", Return_to_main_menu_br5dt0_d0a0);
    Return_to_main_menu_br5dt0_d0a0.setAction("back", false);
    Return_to_main_menu_br5dt0_d0a0.childs = new ArrayList<Event>();
    Event Exit_br5dt0_c0a0 = new Event("Exit", "3");
    Exit_br5dt0_c0a0.isFinal = false;
    Exit_br5dt0_c0a0.setAction("", false);
    Exit_br5dt0_c0a0.playback = "We are sorry, that you are leaving this menu. Looking forward to hear you again. Goodbye.";
    Exit_br5dt0_c0a0.childs = new ArrayList<Event>();
    Variables.myHashMap.put("013", Exit_br5dt0_c0a0);
    Exit_br5dt0_c0a0.setAction("hangUp", true);
    Exit_br5dt0_c0a0.childs = new ArrayList<Event>();
    Internet_br5dt0_a0.childs = new ArrayList<Event>();
    Internet_br5dt0_a0.childs.add(Discount_br5dt0_a0a0);
    Internet_br5dt0_a0.childs.add(Data_limit_br5dt0_b0a0);
    Internet_br5dt0_a0.childs.add(Exit_br5dt0_c0a0);
    Internet_br5dt0_a0.childs.add(Return_to_main_menu_br5dt0_d0a0);
    ...
    Roaming_br5dt0_c0.setAction("getInfo", false);
    Roaming_br5dt0_c0.childs = new ArrayList<Event>();
    ...
    Record_br5dt0_f0.setAction("record", false);
    Record_br5dt0_f0.childs = new ArrayList<Event>();
