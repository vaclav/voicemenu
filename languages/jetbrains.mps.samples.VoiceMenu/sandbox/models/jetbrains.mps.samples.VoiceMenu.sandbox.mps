...
<model ref="r:c63049db-e50d-4836-955e-67b0ba670048(jetbrains.mps.samples.VoiceMenu.sandbox)">
  ...
  <node concept="2Jqgb4" id="1dkJyTcULCU">
    ...
    <node concept="2C_Ik4" id="1dkJyTcULCV" role="2JqgbB">
      ...
      <node concept="2C_I21" id="dcxjWHMMgn" role="2C_I26">
        <ref role="2C_gVZ" node="dcxjWHMMg$" resolve="xx" />
        <node concept="1$pBvq" id="dcxjWHNnT5" role="2C_gVu" />
      </node>
      ...
      <node concept="2C_Ik0" id="dcxjWHMMg$" role="2C_I24">
        <property role="TrG5h" value="xx" />
        <property role="2C_Iks" value="4" />
        <ref role="D9pxj" node="dcxjWHMMgn" />
      </node>
    </node>
  </node>
